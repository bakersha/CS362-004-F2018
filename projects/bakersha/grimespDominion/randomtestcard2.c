...
//		int currentPlayer = rand() % numPlayers;
		...
		*/
		...
		//testState.handCount[currentPlayer] = 499;
		//int startingHandCount = testState.handCount[currentPlayer];
		int startingHandCount = testState.handCount[currentPlayer];
		printf("currentPlayer startingHandCount: %d\n", startingHandCount);		
...
///////////////////////////////////////////////////////////////////////////////////////
		...
		otherPlayerStartingHandCount[0] = 5;
		otherPlayerStartingDeckCount[0] = 5;
		otherPlayerExpectedHandCount[0] = 0;
		otherPlayerExpectedDeckCount[0] = 5;
		otherPlayerStartingDiscardCount[0] = 0;

        otherPlayerStartingHandCount[1] = 0;
        otherPlayerStartingDeckCount[1] = 10;
        otherPlayerExpectedHandCount[1] = 0;
        otherPlayerExpectedDeckCount[1] = 10;
        otherPlayerStartingDiscardCount[0] = 0;

        otherPlayerStartingHandCount[2] = 0;
        otherPlayerStartingDeckCount[2] = 10;
        otherPlayerExpectedHandCount[2] = 0;
        otherPlayerExpectedDeckCount[2] = 10;
        otherPlayerStartingDiscardCount[2] = 0;
